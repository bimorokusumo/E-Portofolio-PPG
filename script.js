...
// Function to reveal EP2 content
window.revealEP2Content = function(targetId, e) {
    if(e) e.preventDefault();
    
    const mainContent = document.getElementById('ep2-main-content');
    ...
    // Re-initialize intersection observers for the newly visible elements
    const reveals = mainContent.querySelectorAll('.reveal');
    const revealOptions = {
        threshold: 0.15,
        rootMargin: "0px 0px -50px 0px"
    };
    ...
    // Scroll to target smoothly after a tiny delay to allow display:block to render
    setTimeout(() => {
